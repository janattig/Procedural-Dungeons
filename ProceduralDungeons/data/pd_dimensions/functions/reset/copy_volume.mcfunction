...
execute if score %current_reset_region_size pd_dimensions matches 18..19 run execute store success score %successful_reset pd_dimensions run clone 12300000 ~ 12300000 12300019 ~100 12300019 ~-9 ~ ~-9
