...
data modify storage pd_dimensions:bunny_jump_world reset_regions append from entity @e[tag=pd_dim_marker_tmp,limit=1] Pos

# kill the marker
kill @e[type=marker, tag=pd_dim_marker_tmp]

# show that there has been modifications
scoreboard players set %has_been_modified pd_dimension_bunny_jump 1
