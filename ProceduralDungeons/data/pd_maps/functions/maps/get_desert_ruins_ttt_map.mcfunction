...
# set all parameters
data modify storage procedural_dungeons:current_map id set value 31
data modify storage procedural_dungeons:current_map display_name set value "Desert Ruins"
