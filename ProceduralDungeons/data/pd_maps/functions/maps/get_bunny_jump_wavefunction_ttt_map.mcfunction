...
data modify storage procedural_dungeons:current_map room_filling_percentage_min set value 100
...
data modify storage procedural_dungeons:current_map priority_percentage_max set value 90
