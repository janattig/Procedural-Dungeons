...
data modify storage procedural_dungeons:current_map display_name set value "Skyblock"

# set the map size
scoreboard players set %extent_min pd_maps 4
scoreboard players set %extent_max pd_maps 8
...
scoreboard players set %LCG_rand_max pd_math 30
function pd_math:rand/update
...
data modify storage procedural_dungeons:current_map portal_target set value [1.0d, 40.0d, 1.0d]
