execute store result score %tmp_extent pd_maps run data get storage procedural_dungeons:current_map extent_x
...
execute store result storage procedural_dungeons:current_map min_x int 1 run scoreboard players get %tmp_min pd_maps
execute store result storage procedural_dungeons:current_map max_x int 1 run scoreboard players get %tmp_max pd_maps
