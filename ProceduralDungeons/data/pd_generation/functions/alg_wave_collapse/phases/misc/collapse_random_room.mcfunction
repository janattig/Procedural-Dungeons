...
execute if score %rooms_to_collapse pd_level_parameters matches 1.. run schedule function pd_generation:alg_wave_collapse/phases/misc/collapse_random_room 1t
execute if score %rooms_to_collapse pd_level_parameters matches 0 run schedule function pd_generation:alg_wave_collapse/phases/5_cleanup 1t
