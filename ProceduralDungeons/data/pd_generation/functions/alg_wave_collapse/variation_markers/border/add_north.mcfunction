...
scoreboard players operation %current_z wfc_coordinates += %d_north wfc_distances
...
execute at @e[tag=wfc_cursor] run tag @e[tag=pd_border, distance=..0.1] add wfc_has_south


# remove the need for a north connection
tag @s remove wfc_need_north
