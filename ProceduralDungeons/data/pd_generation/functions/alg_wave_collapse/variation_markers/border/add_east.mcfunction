...
scoreboard players operation %current_x wfc_coordinates += %d_east wfc_distances
...
execute at @e[tag=wfc_cursor] run tag @e[tag=pd_border, distance=..0.1] add wfc_has_west


# remove the need for an east connection
tag @s remove wfc_need_east
