...
execute store result storage procedural_dungeons:current_level all_variations[0].north int 1 run scoreboard players get %connection_n pd_room_parameters
execute store result storage procedural_dungeons:current_level all_variations[0].south int 1 run scoreboard players get %connection_s pd_room_parameters
execute store result storage procedural_dungeons:current_level all_variations[0].east int 1 run scoreboard players get %connection_e pd_room_parameters
execute store result storage procedural_dungeons:current_level all_variations[0].west int 1 run scoreboard players get %connection_w pd_room_parameters
...
data modify storage procedural_dungeons:current_level all_variations[0].rotation set value "NONE"
