...
tellraw @a [{"text":"  > grid has extent ", "color":"gray"},{"score":{"name":"%tmp_1","objective":"pd_level_parameters"}, "color":"white"},{"text":"x", "color":"gray"}, {"score":{"name":"%tmp_2","objective":"pd_level_parameters"}, "color":"white"},{"text":" rooms", "color":"gray"}]
