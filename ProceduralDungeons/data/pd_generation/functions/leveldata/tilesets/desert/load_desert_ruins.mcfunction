...
data modify storage procedural_dungeons:current_level all_rooms append from storage procedural_dungeons:level_data all_rooms[{map:"desert", size:17, ruins:1}]
...
scoreboard players set %start_y pd_level_parameters 61
